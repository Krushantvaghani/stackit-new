...
class ScaleSize {
  ...
  void init(BuildContext context) {
    ...
    safeHeight = (screenWidth - _safeAreaHeight);
...
class Space {
  ...
  static Widget height(double space) {
    return SizedBox(
      height: ScaleSize.getScaledSizeHeight(space),
    );
  }

  static Widget width(double space) {
    return SizedBox(
      width: ScaleSize.getScaledSizeHeight(space),
    );
  }
}
...
class Shape {
  static dynamic circular(double radius,
    ...
    BorderRadius borderRadius = BorderRadius.all(
        Radius.circular(ScaleSize.getScaledSizeHeight(radius)));
  ...
  static dynamic circularTop(double radius,
    ...
    BorderRadius borderRadius = BorderRadius.only(
        topLeft: Radius.circular(ScaleSize.getScaledSizeHeight(radius)),
        topRight: Radius.circular(ScaleSize.getScaledSizeHeight(radius)));
    switch (shapeTypeFor) {
      case ShapeTypeFor.container:
        return borderRadius;
